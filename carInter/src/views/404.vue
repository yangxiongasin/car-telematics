<template>
  <div class="notFound">
    ...
    <g id="head" class="up">
        <g id="leftAntenna">
            <path fill="none" stroke="#ccc" stroke-width="1.5" stroke-miterlimit="10" d="M 77.519 25.869 C 75.85 13.604 65.745 3.39 53.972 6.26466">
            ...
            <ellipse fill="#ccc" cx="55.021" cy="6.26466" rx="3.344" ry="3.391">
        ...
        <g id="rightAntenna">
            <path fill="none" stroke="#ccc" stroke-width="1.5" stroke-miterlimit="10" d="M 82.48 25.869 C 84.15 13.604 94.255 3.39 106.028 8.32933">
            ...
            <ellipse fill="#ccc" cx="104.979" cy="8.32933" rx="3.344" ry="3.391">
        ...
        <g>
            <g id="eyeLeft">
                <path fill="#FFFFFF" d="M 72.116 47.955 c 0 5.443 -0.170617 9.853 -9.033 9.853 h -1.971 c -4.988 0 -9.032 -4.41 -9.032 -9.853 s 4.044 -5.01302 9.032 -5.01302 h 1.971 C 68.071 44.8792 72.116 42.512 72.116 47.955 Z">
            ...
            <g>
                <path fill="#FFFFFF" d="M 107.92 47.955 c 0 5.443 -4.045 9.853 -9.031 9.853 h -1.973 c -4.986 0 -9.031 -4.41 -9.031 -9.853 s 4.045 -5.01302 9.031 -5.01302 h 1.973 C 103.875 44.8792 107.92 42.512 107.92 47.955 Z">
                    <animate attributeName="d" calcMode="spline" keySplines="0.42 0 0.58 1; 0.42 0 0.58 1" begin="5s" dur="0.8s" repeatCount="indefinite" values="
        ...
        <path fill="#FFFFFF" d="M 103.383 69.778 c 0 1.381 -0.845905 2.59186 -1.871 2.499 c -10.9685 -1.03426 -31.3144 -0.908381 -43.025 0 c -1.02722 0.0705739 -1.871 -1.118 -1.871 -2.499 c 0 -1.378 0.859461 -2.62931 1.871 -2.496 c 12.5864 2.0615 31.5096 1.41684 43.025 0 C 102.532 67.1697 103.383 68.4 103.383 69.778 Z">
